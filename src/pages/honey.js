...
<p>{'Well, I’m sure that if you ended up on this website you already know what honey is. But you may not know that:'}</p>
    ...
    <p>{'These antioxidants have been linked to reduced risk of heart attacks, strokes and some types of cancer. They may also promote eye health and seems to have a positive effect on cholesterol levels. (1, 2)'}</p>
...
<p>{'With the a milder climate and a wider range of food than the countryside, urban centers are becoming havens for bee population far from the uses of pesticides in the intensive agriculture in the farm land (6).'}</p>

<p>{'“Apart from crops such as oilseed rape and field beans, there are precious few pollen sources around for bees and other insects in modern arable farmland and surprisingly little in areas specialising in dairy, beef or sheep production,”. (7) This is leading to an increasing in urban beekeepers due to the more diversity of flowers in cities, with gardens, parks, railway sidings all planted with different species, and for this reason, bees in urban environments with a variety of foraging sources, play also a vital role in conservation and pollination. (8).'}</p>

<p>{'Is urban honey as good as honey produced in farm land?'}</p>
<p>{'Just check this research 😉 '}</p>
    </div>
